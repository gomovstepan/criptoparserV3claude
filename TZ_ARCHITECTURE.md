...
> Исправлено: раньше здесь стояло 50,000 — арифметическая ошибка, сумма строк
> выше даёт 55,000. Код (`executor/balance.py::INITIAL_BALANCES_USDT`) всегда
> соответствовал построчным значениям.
